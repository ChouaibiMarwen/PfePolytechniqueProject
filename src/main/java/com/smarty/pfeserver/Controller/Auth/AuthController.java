package com.smarty.pfeserver.Controller.Auth;
...
import com.smarty.pfeserver.Request.User.LogOutRequest;
import com.smarty.pfeserver.Request.User.SignInRequest;
import com.smarty.pfeserver.Request.auth.TokenRefreshRequest;
import com.smarty.pfeserver.Response.Auth.JwtResponse;
import com.smarty.pfeserver.Response.Auth.OnUserLogoutSuccessEvent;
import com.smarty.pfeserver.Response.Tools.ApiResponse;
import com.smarty.pfeserver.Services.User.UserService;
import com.smarty.pfeserver.Services.auth.MailSenderServices;
import com.smarty.pfeserver.Services.auth.PasswordResetTokenServices;
...
import com.smarty.pfeserver.Tools.Exception.TokenRefreshException;
import com.smarty.pfeserver.Tools.Exception.UserLogoutException;
...
public class AuthController extends BaseController {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('TECHNICIEN') or hasRole('SUPPLIER') or hasRole('SUB_SUPPLIER') or hasRole('SUB_ADMIN') or hasRole('SUB_DEALER') or hasRole('SUB_SUB_DEALER')")
